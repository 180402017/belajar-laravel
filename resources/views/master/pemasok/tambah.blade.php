    ...
    <div class="col-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('pemasok.store') }}">
            @csrf
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="number" class="form-control" id="telp" name="telp" value="{{ old('telp') }}">
                  <div class="text-danger">
                    @error('telp')
                    {{ $message }}
                    @enderror
