...
<head>
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="{{ asset('template/overlayScrollbars/css/OverlayScrollbars.min.css') }}">
  <!-- summernote -->
  ...
  <!-- Summernote -->
  <script src="{{ asset('template/summernote/summernote-bs4.min.js') }}"></script>
</head>
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('master') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
...
<!-- overlayScrollbars -->
<script src="{{ asset('template/overlayScrollbars/js/jquery.overlayScrollbars.min.js') }}"></script>
<!-- AdminLTE App -->
